    ...
    return(
        <div>
            ...
            <div className="aboutIntro">
               ...
               <TextBox className="aboutMessage1 TextDesign">
          ...
          {  <div className="clear"></div>}
            ...
            <h2 className="our_services_intro">What we are best known for</h2>
           ...
           {/*  Repeating aboutSection2 and 3 since the layours are the same */}
            <div className="aboutSection2">
                <CheckBox>
